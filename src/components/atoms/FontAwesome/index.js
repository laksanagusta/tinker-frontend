...
import { faLaravel as fabLaravel, faJs as fabJs, faPhp as fabPhp } from '@fortawesome/free-brands-svg-icons'
 
library.add(farFaStar, fasFaStar, fasFaStarHalfAlt, faHeart, fabLaravel, fabJs, fasDatabase, fabPhp, fasRobot, fasFolderOpen)